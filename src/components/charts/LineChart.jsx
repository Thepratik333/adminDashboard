...
const BarCharts = () => {
  return (
    <div className="admin-container overflow-y-auto w-full flex flex-col">
    <h1 className='my-[3px] ml-[60px] text-[50px]'>Line Charts</h1>
      <main className="chart-container p-28">
        <section >
          <LineChart
            data={[
